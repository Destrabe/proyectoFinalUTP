...
public class deadpool extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/deadpoolLogo.jpg"))); // NOI18N

        jLabel3.setFont(new java.awt.Font("Roboto Black", 1, 48)); // NOI18N
        jLabel3.setText("Deadpool & Wolverine");
        ...
        textArea.setRows(5);
        textArea.setText("Wolverine se recupera de sus heridas cuando se cruza con \nDeadpool, que ha viajado en el tiempo para curarlo con la \nesperanza de hacerse amigos y formar un equipo para \nacabar con un enemigo común");
        ...
        jLabel4.setText("Acción | 2hrs 10min | +14");

        jLabel6.setFont(new java.awt.Font("Roboto Black", 1, 24)); // NOI18N
        jLabel6.setText("Selecione el dia");
        ...
        jPanel1.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 56, 872, -1));
